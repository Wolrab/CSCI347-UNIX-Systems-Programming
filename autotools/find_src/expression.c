...
/**
 * A library to create a simple expression with primaries and their arguments
 *   linked together with logical &'s. Each primary has at least two inputs, 
 *   the stat information of some file and arguments passed into the primary 
 *   from the user. Optionally each primary can access globally available state
 *   information if needed.
 * An expression is parsed from a series of expression arguments. Once the 
